...
export default {
  ...
  methods: {
    ...
    // 下载配置文件的方法,因为跨域的问题不知道怎么解决,暂时放弃
    // DownloadConfigFile(){
    //   let newUrl = 'http://39.98.85.153:19001/service-configfile/gKaq3oEIdHzmbYOxesDMUX67fBiuWPQc5CGT2R01Nw8ZjnyJVF?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=lishuwei%2F20211110%2F%2Fs3%2Faws4_request&X-Amz-Date=20211110T055014Z&X-Amz-Expires=86400&X-Amz-SignedHeaders=host&X-Amz-Signature=eeda81e21f94c09f32814d958139785c8974c13a8b89ff2bb2f699acea9b2b50'
    //   let a = document.createElement("a");
    //   a.href = newUrl;
    //   a.download = 'admin.txt';
    //   a.click();
    //   a.remove();
